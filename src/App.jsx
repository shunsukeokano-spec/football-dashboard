...
function App() {
  ...
  const renderError = () => {
    ...
    // Only show full-screen error if we have NO matches to show
    if (!apiError || matches.length > 0) return null;
    ...
    return (
      <div className="bg-red-500/10 border border-red-500/50 rounded-lg p-4 mb-8">
        <div className="flex items-start">
          ...
          <div className="ml-3">
            <h3 className="text-sm font-medium text-red-500">API Error Detected</h3>
            <div className="mt-2 text-sm text-red-400">
              <p>The application encountered an issue fetching live data.</p>
